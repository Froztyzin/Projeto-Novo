...
export const PlansList: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">Planos de Matrícula</h2>
      ...
      {plans.length > 0 ? (
        ...
        <div className="text-center py-16">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Comece adicionando um novo plano de matrícula.</p>
        </div>
      )}
