...
export const NotificationsPanel: React.FC<NotificationsPanelProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-40" onClick={onClose} aria-labelledby="notification-panel-title" role="dialog" aria-modal="true">
            ...
            >
                <div className="flex justify-between items-center p-4 border-b border-slate-700">
                    <h3 id="notification-panel-title" className="font-semibold text-lg text-slate-100">Notificações</h3>
                    <button onClick={onClose} className="text-slate-400 hover:text-slate-200" aria-label="Fechar painel de notificações">
